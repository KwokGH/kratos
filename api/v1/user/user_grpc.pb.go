...
type UserClient interface {
	...
	GetUserDetail(ctx context.Context, in *GetUserDetailReq, opts ...grpc.CallOption) (*UserDetailReply, error)
}
...
func (c *userClient) GetUserDetail(ctx context.Context, in *GetUserDetailReq, opts ...grpc.CallOption) (*UserDetailReply, error) {
	out := new(UserDetailReply)
	err := c.cc.Invoke(ctx, "/api.v1.user.User/GetUserDetail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServer) GetUserDetail(context.Context, *GetUserDetailReq) (*UserDetailReply, error) {
...
func _User_GetUserDetail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.v1.user.User/GetUserDetail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
